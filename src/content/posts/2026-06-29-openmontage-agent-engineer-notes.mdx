...
ogImage: ./assets/2026-06-29-openmontage-agent-engineer-notes/cover.png
tags:
  - "OpenMontage"
  - "Agent"
  - "AI-video"
...
![cover](./assets/2026-06-29-openmontage-agent-engineer-notes/cover.png)
...
![三层知识架构：工具与声明、项目约定、外部技术知识](./assets/2026-06-29-openmontage-agent-engineer-notes/diagram-three-layers.png)
...
![自描述工具契约：BaseTool、ToolRegistry、Selector 与多维评分](./assets/2026-06-29-openmontage-agent-engineer-notes/diagram-tool-contract.png)
...
![管线与检查点：YAML 阶段契约 + JSON 状态机](./assets/2026-06-29-openmontage-agent-engineer-notes/diagram-pipeline-checkpoint.png)
...
![质量治理与合成/火山引擎栈](./assets/2026-06-29-openmontage-agent-engineer-notes/diagram-governance-composition.png)
