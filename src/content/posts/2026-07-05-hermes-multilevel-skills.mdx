...
description: "我最近看 Hermes Agent 的 skills 设计，被一个很小的目录细节绊了一下。"
...
![Hermes 多层 Skills 路径：从混乱的扁平技能堆到有序的分层技能体系](./assets/2026-07-05-hermes-multilevel-skills/20260705-113735-hermes-multilevel-skills.png)
...
![扁平布局与嵌套布局对比：左侧是长名称的扁平目录，右侧是按来源分类的多层目录树](./assets/2026-07-05-hermes-multilevel-skills/20260705-112058-flat-vs-nested-skill-directories.png)
...
![Hermes Skill Package 解剖：SKILL.md 入口与 references、templates、assets、scripts 支持目录，以及渐进加载的三层结构](./assets/2026-07-05-hermes-multilevel-skills/20260705-112148-hermes-skill-package-anatomy.png)
...
![Hermes 技能发现边界：递归扫描跳过支持目录，skill_view 先按路径再按名称匹配，同名冲突返回歧义警告](./assets/2026-07-05-hermes-multilevel-skills/20260705-112250-skill-discovery-boundary.png)
