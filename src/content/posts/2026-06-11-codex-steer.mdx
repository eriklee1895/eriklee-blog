...
description: "你让 Codex 修一个 flaky 的集成测试。它先去装依赖、跑了一遍全量 suite,然后开始改测试文件本身——把一个本该红的断言改绿了。你想喊停:别动测试,去看业务代码。"
pubDatetime: 2026-06-11T00:00:00Z
author: "Erik Lee"
draft: false
category: "AI Engineering"
series: "Codex Notes"
ogImage: ./assets/2026-06-11-codex-steer/20260611-192628-codex-steer-cover.png
tags:
  - "others"
source: "article.md"
---
...
![Steer:让 Agent 边跑边转向 —— mid-turn steering](./assets/2026-06-11-codex-steer/20260611-192628-codex-steer-cover.png)
...
![Steer / Queue / Interrupt 三原语](./assets/2026-06-11-codex-steer/20260611-193547-steer-vs-queue-vs-interrupt.png)
...
![中途注入的三道关卡](./assets/2026-06-11-codex-steer/20260611-193547-the-mid-turn-injection-problem.png)
...
![Codex 四层架构](./assets/2026-06-11-codex-steer/20260611-193547-codex-steer-architecture.png)
...
![Hermes 线程模型](./assets/2026-06-11-codex-steer/20260611-193547-hermes-steer-thread-model.png)
...
![Hermes marker 内联注入](./assets/2026-06-11-codex-steer/20260611-193547-hermes-marker-inline-injection.png)
...
![Codex vs Hermes:两条实现路径](./assets/2026-06-11-codex-steer/20260611-193547-codex-vs-hermes-two-paths.png)
...
![Mid-Turn Steering Landscape 2026](./assets/2026-06-11-codex-steer/20260611-193547-mid-turn-steering-landscape-2026.png)
...
![从聊天窗口到 Agent 控制台](./assets/2026-06-11-codex-steer/20260611-193057-codex-steer-09-paradigm-shift.png)
