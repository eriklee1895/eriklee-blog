...
![一个看似朴素的 Markdown 文件成为开源现象，不到一周涨到 16500 星](./assets/2026-06-14-skill-creator-eval-framework/20260615-175744-markdown.png)
...
![skill-creator 四模式生命周期：Create → Eval → Improve → Benchmark 循环迭代](./assets/2026-06-14-skill-creator-eval-framework/20260615-175034-skill-creator.png)
...
![功能评测 Benchmark 数据流：evals.json 分叉成 16 个并行 agent，经 Grader 机械评分汇聚到 benchmark.json](./assets/2026-06-14-skill-creator-eval-framework/20260615-175207-benchmark.png)
...
![触发评测 Trigger Eval 优化循环：20 条查询经 train/test 分割，run_loop.py 迭代优化，按 test 分数选出 best_description](./assets/2026-06-14-skill-creator-eval-framework/20260615-175323-trigger-eval.png)
...
![从手艺到工程：左侧手工打磨的 SKILL.md 指令，右侧工程化、规范化的蓝图结构](./assets/2026-06-14-skill-creator-eval-framework/20260615-175814-article-illustration.png)
